<script setup>
import { ref } from 'vue'
import employee_nav  from '../components/nav/employee_nav.vue'
import homee  from '../components/employee/home.vue'
import meenu  from '../components/employee/menu.vue'
import acc  from '../components/employee/account.vue'
...
<template>
  <employee_nav @click="()=>{console.log(selectmenu)
  }" @clickmenu="(menu)=>{
    selectmenu = menu
  }" />
  ...
  <div class="container">
    ...
    <withdraw v-if="selectmenu == 'withdraw'" />
